...
int password[] = { leftHand , leftHand , rightHand, leftHand, rightHand, rightHand, leftHand}; // change length
...
void finalLight() {
  do {
    colorWipe(pixels.Color(0, 0, 150), 50);
    colorWipeTwo(pixels2.Color(0, 0, 150), 50);
    delay(500);
    colorWipe(pixels.Color(0, 0, 0), 50);
    colorWipeTwo(pixels2.Color(0, 0, 0), 50);
    delay(500);
